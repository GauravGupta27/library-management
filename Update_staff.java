...
public class Update_staff extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            jLabel14.setText("Please enter Staff name !!!");
        ...
        Statement  st=conn.createStatement();
         st.executeUpdate("update staff_details set staff_id='"+staff_id+"' , name='"+name+"' , father_name='"+father_name+"' , "
                 + "dob='"+dob+"', contact_no='"+contact+"', email='"+email+"' , gender='"+gender+"' , designation='"+designation+"' , working_since='"+working_since+"' , "
                 + "salary='"+salary+"' , address='"+address+" ' where staff_id='"+staff_id+"' ");
         jTextField8.setText("");
        jTextField3.setText("");
        jTextField4.setText("");
        jTextField5.setText("");
    ...
    private void jTextField8FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField8FocusLost
        String st_id=jTextField8.getText();
      try{
            Class.forName("oracle.jdbc.driver.OracleDriver");
        Connection conn=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","system","system");
        Statement  st=conn.createStatement();
        ResultSet rs=st.executeQuery("select * from staff_details where staff_id='"+st_id+"'");
        if(rs.next())
        {
